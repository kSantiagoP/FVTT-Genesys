...
// Cast seguro para evitar erro de tipagem da V14 no CONFIG do Foundry
const FoundryDie = (globalThis as any).Die ?? (CONFIG as any).Dice?.terms?.['d'];

/**
 * Base type of all custom Genesys dice.
 */
export default abstract class GenesysDie extends (FoundryDie as any) {
    /**
     ...
     */
    get denomination() {
        return (this.constructor as typeof FoundryDie).DENOMINATION;
    }
     ...
     */
    getResultCSS(_: DiceTermResult): (string | null)[] {
